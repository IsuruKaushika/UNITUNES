      ...
      <div className="max-w-4xl mx-auto mb-8 flex gap-4">
        ...
        <div className="flex border border-gray-200 rounded-xl overflow-hidden">
          <button
            ...
            className={`px-4 py-2 ${viewMode === "grid" ? "bg-yellow-300" : ""}`}
          >
            Grid
          </button>
          <button
            onClick={() => setViewMode("list")}
            className={`px-4 py-2 ${viewMode === "list" ? "bg-yellow-300" : ""}`}
          >
            List
          </button>
        </div>
            ...
            {filtered
              ...
              .map((item) => (
                <div
                  ...
                  className="bg-white rounded-2xl shadow hover:shadow-xl p-4 cursor-pointer relative"
                >
                  <img
                    src={item.image?.[0]}
                    alt={item.title}
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <button
                      ...
                      className={`p-2 rounded-full ${
                        favorites.includes(item._id) ? "text-red-500" : "text-gray-400"
                      }`}
                    >
                      ❤️
                    </button>
