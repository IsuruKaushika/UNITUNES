...
const BakeryScreen = () => {
  ...
  const bakeryItems = [
    { id: '1', name: 'Books', image: require('../../assets/images/BookshopItems.png'), contact: '074-0234567' },
    { id: '2', name: 'Papers', image: require('../../assets/images/BookshopItems.png'), contact: '074-0234567' },
    { id: '3', name: 'Pens', image: require('../../assets/images/BookshopItems.png'), contact: '074-0234567' },
    { id: '4', name: 'Pencils', image: require('../../assets/images/BookshopItems.png'), contact: '074-0234567' },
  ];
