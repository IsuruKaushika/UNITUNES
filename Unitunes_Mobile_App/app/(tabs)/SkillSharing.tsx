...
const defaultImage = require('../../assets/images/Skill Sharing.jpg'); // Add a relevant image in assets

export default function SkillShareList() {
  ...
  useEffect(() => {
    async function fetchSkills() {
      try {
        ...
        console.error('Error fetching skill sharing data:', err);
      } finally {
        setLoading(false);
      }
    }
    ...
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.list}>
          <Text style={styles.pageTitle}>Skill Sharing</Text>
          <Text style={styles.pageSubtitle}>Tap a skill to see details</Text>
          {skills.length > 0 ? (
            skills.map((item) => (
              <TouchableOpacity
                key={item._id}
              ...
              >
                ...
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.cardText}>
                    Provider: {item.providerName || 'Not available'}
                  </Text>
                  <Text style={styles.cardText}>
