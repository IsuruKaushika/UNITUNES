...
const BakeryScreen = () => {
  ...
  const bakeryItems = [
    { id: '1', name: 'Printout', image: require('../../assets/images/CommunicationItems.png'), contact: '074-0234567' },
    { id: '2', name: 'Email', image: require('../../assets/images/CommunicationItems.png'), contact: '074-0234567' },
    { id: '3', name: 'Photocopy', image: require('../../assets/images/CommunicationItems.png'), contact: '074-0234567' },
  ];
