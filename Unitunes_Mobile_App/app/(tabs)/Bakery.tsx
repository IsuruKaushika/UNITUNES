...
const BakeryScreen = () => {
  ...
  const bakeryItems = [
    { id: '1', name: 'Donut', image: require('../../assets/images/BakeryItems.png'), contact: '074-0234567' },
    { id: '2', name: 'Cake', image: require('../../assets/images/BakeryItems.png'), contact: '074-0234567' },
    { id: '3', name: 'Pastry', image: require('../../assets/images/BakeryItems.png'), contact: '074-0234567' },
    { id: '4', name: 'Bread', image: require('../../assets/images/BakeryItems.png'), contact: '074-0234567' },
  ];
